...
export type ScheduledOperationAffectedDocument = Asset | Order | OrderItem | Product;
...
export type GetProductsQuery = { products: Array<{ id: string, name: string, price: number, image: { url: string } }> };
